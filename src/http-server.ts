...
const TOOLS = [
  ...
  },
  {
    ...
    description: "Search NESO grid codes (Grid Code, CUSC, BSC, STC, DCUSA, SQSS), balancing rules, and connection requirements.",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description: "Search Ofgem price control determinations (RIIO), market reform decisions, supplier licensing, and enforcement actions.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query" },
