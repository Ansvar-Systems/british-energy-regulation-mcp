/**
 * SQLite database access layer for the British Energy Regulation MCP server.
 *
 * Schema covers four British energy regulators:
 *   - regulations      — Ofgem licence conditions, DESNZ Acts/SIs, HSE safety rules
 *   - grid_codes       — NESO Grid Code, CUSC, BSC, STC, DCUSA, SQSS
 *   - decisions        — Ofgem RIIO determinations, market reform, enforcement
 *
